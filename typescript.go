...
func (r *Registry) GenerateTypeScript(w io.Writer, class, binary string, options ...Option) error {
	...
	fmt.Fprintln(&b, "import { Client as _bridgeClient, DefaultControl as _bridgeDefaultControl, resolveBinary as _bridgeResolveBinary, parseSchema as _bridgeParseSchema, encode as _bridgeEncode, compileCodec as _bridgeCompileCodec } from \"gobridge-runtime\";")
