...
| --- | --- | --- |
| `name` | `acme_greeter` | Python imports and bundled executable filename |
...
Python's `acme_greeter` is an organization-prefixed import name; dotted namespace
packages such as `acme.greeter` are not currently generated by `gobridge build`.
