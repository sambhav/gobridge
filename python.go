...
func (r *Registry) GeneratePython(w io.Writer, class, binary string, options ...Option) error {
	...
	for _, n := range strings.Fields("Client RuntimeOptions DefaultControl decode dataclass resolve_binary configure session session_sync shutdown shutdown_sync str int float bool dict list") {
		reserved[n] = true
	}
